...
$mainValues = [
    ...
    'increase_wallet_cart_to_cart'=>"♻️ دوست خوبم یه تصویر از فیش واریزی برام ارسال کن :
...
💰قیمت: PRICE تومان",
    ...
    'join_channel_message'=>"❌ برای استفاده از ربات حتما باید در کانال زیر عضو شوید (این کانال برای اطلاع رسانی و راهنمایی به شما دوست عزیز هست):
...
",
    ...
    'start_message'=>'
☎️ پشتیبانی ما 24 ساعته شبانه روز
✅ با خیال تخت خریدتو بزن

برای دیدن منوی اصلی /start رو بزن',
