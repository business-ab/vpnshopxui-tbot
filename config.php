...
function getAgentKeys(){
    ...
    return json_encode(['inline_keyboard'=>[
        [['text'=>$boughtAccounts,'callback_data'=>"VPNFREE_4"],['text'=>$buttonValues['agent_bought_accounts'],'callback_data'=>"VPNFREE_4"]],
        [['text'=>$joinedDate,'callback_data'=>"VPNFREE_4"],['text'=>$buttonValues['agent_joined_date'],'callback_data'=>"VPNFREE_4"]],
        [['text'=>$agencyDate,'callback_data'=>"VPNFREE_4"],['text'=>$buttonValues['agent_agency_date'],'callback_data'=>"VPNFREE_4"]],
...
function getRejectedAgentList(){
    ...
    if($list->num_rows>0){
        $keys = array();
        $keys[] = [['text'=>"آزاد ساختن",'callback_data'=>"VPNFREE_4"],['text'=>"اسم کاربر",'callback_data'=>'VPNFREE_4'],['text'=>"آیدی عددی",'callback_data'=>"VPNFREE_4"]];
        while($row = $list->fetch_assoc()){
            ...
            $keys[] = [['text'=>"✅",'callback_data'=>"releaseRejectedAgent" . $userId],['text'=>$fullName,'callback_data'=>"VPNFREE_4"],['text'=>$userId,'callback_data'=>"VPNFREE_4"]];
        }
...
function getAgentDetails($userId){
    ...
    return json_encode(['inline_keyboard'=>[
        [
            ['text'=>"(" . $todayIncome['count'] . ") " . number_format($todayIncome['total']),'callback_data'=>'VPNFREE_4'],
            ['text'=>"درآمد امروز",'callback_data'=>'VPNFREE_4']
            ],
        [
            ['text'=>"(" . $yesterdayIncome['count'] . ") " . number_format($yesterdayIncome['total']),'callback_data'=>"VPNFREE_4"],
            ['text'=>"درآمد دیروز",'callback_data'=>"VPNFREE_4"]
            ],
        [
            ['text'=>"(" . $lastWeekIncome['count'] . ") " . number_format($lastWeekIncome['total']),'callback_data'=>"VPNFREE_4"],
            ['text'=>"درآمد یک هفته",'callback_data'=>"VPNFREE_4"]
            ],
        [
            ['text'=>"(" . $lastMonthIncome['count'] . ") " . number_format($lastMonthIncome['total']),'callback_data'=>"VPNFREE_4"],
            ['text'=>"درآمد یک ماه",'callback_data'=>"VPNFREE_4"]
            ],
...
function getAgentsList($offset = 0){
    ...
    $keys[] = [['text'=>"حذف",'callback_data'=>"VPNFREE_4"],['text'=>"درصد تخفیف",'callback_data'=>"VPNFREE_4"],['text'=>"تاریخ نمایندگی",'callback_data'=>"VPNFREE_4"],['text'=>"اسم نماینده",'callback_data'=>"VPNFREE_4"],['text'=>"آیدی عددی",'callback_data'=>"VPNFREE_4"]];
    if($agentList->num_rows > 0){
        while($row = $agentList->fetch_assoc()){
            ...
            $keys[] = [['text'=>"❌",'callback_data'=>"removeAgent" . $userId],['text'=>"⚙️",'callback_data'=>"agentPercentDetails" . $userId],['text'=>$joinedDate,'callback_data'=>"VPNFREE_4"],['text'=>$fullName,'callback_data'=>"agentDetails" . $userId],['text'=>$userId,'callback_data'=>"agentDetails" . $userId]];
        }
    }
...
function getAgentDiscounts($agentId){
    ...
    $keys[] = [['text'=>" ",'callback_data'=>"VPNFREE_4"],
    ['text'=>$normal . "%",'callback_data'=>"editAgentDiscountNormal" . $agentId . "_0"],
    ['text'=>"عمومی",'callback_data'=>"VPNFREE_4"]];            
    ...
    if($botState['agencyPlanDiscount']=="on"){
        foreach($discounts['plans'] as $planId=>$discount){
            ...
            ['text'=>$info['title'] . " " . $catInfo['title'],'callback_data'=>"VPNFREE_4"]];            
        }
    }else{
        foreach($discounts['servers'] as $serverId=>$discount){
            ...
            ['text'=>$info['title'],'callback_data'=>"VPNFREE_4"]];            
        }                
    }
...
function getServerConfigKeys($serverId,$offset = 0){
    ...
    $id = $cty['id'];
    $cname = $cty['title'];
    $flagvpnshop = $cty['flag'];
    $remarkvpnshop = $cty['remark'];
    $ucount = $cty['ucount'];
    ...
    return json_encode(['inline_keyboard'=>[
        [
            ['text'=>$panelUrl,'callback_data'=>"VPNFREE_4"],
            ],
        [
            ['text'=>$cname,'callback_data'=>"editServerName$id"],
            ['text'=>"❕نام سرور",'callback_data'=>"VPNFREE_4"]
            ],
        [
            ['text'=>$flagvpnshop,'callback_data'=>"editServerFlag$id"],
            ['text'=>"🚩 پرچم سرور",'callback_data'=>"VPNFREE_4"]
            ],
        [
            ['text'=>$remarkvpnshop,'callback_data'=>"editServerRemark$id"],
            ['text'=>"📣 ریمارک سرور",'callback_data'=>"VPNFREE_4"]
            ],
        [
            ['text'=>$serverType??" ",'callback_data'=>"changeServerType$id"],
            ['text'=>"نوعیت سرور",'callback_data'=>"VPNFREE_4"]
            ],
        [
            ['text'=>$portType,'callback_data'=>"changePortType$id"],
            ['text'=>"نوعیت پورت",'callback_data'=>"VPNFREE_4"]
            ],
        [
            ['text'=>$ucount,'callback_data'=>"editServerMax$id"],
            ['text'=>"ظرفیت سرور",'callback_data'=>"VPNFREE_4"]
            ],
        [
            ['text'=>$sni,'callback_data'=>"editsServersni$id"],
            ['text'=>"sni",'callback_data'=>"VPNFREE_4"],
            ],
        [
            ['text'=>$headerType,'callback_data'=>"editsServerheader_type$id"],
            ['text'=>"header type",'callback_data'=>"VPNFREE_4"],
            ],
        [
            ['text'=>$requestHeader,'callback_data'=>"editsServerrequest_header$id"],
            ['text'=>"request header",'callback_data'=>"VPNFREE_4"],
            ],
        [
            ['text'=>$responseHeader,'callback_data'=>"editsServerresponse_header$id"],
            ['text'=>"response header",'callback_data'=>"VPNFREE_4"],
            ],
        [
            ['text'=>$security,'callback_data'=>"editsServersecurity$id"],
            ['text'=>"security",'callback_data'=>"VPNFREE_4"],
            ],
        (($serverConfig['type'] == "sanaei" || $serverConfig['type'] == "alireza")?
        [
            ['text'=>$reality,'callback_data'=>"changeRealityState$id"],
            ['text'=>"reality",'callback_data'=>"VPNFREE_4"],
            ]:[]),
        [
        ...
        [
            ['text'=>"✂️ حذف سرور",'callback_data'=>"vpnshopdeleteserver$id"],
            ],
...
function getServerListKeys($offset = 0){
    ...
    $keys = array();
    $keys[] = [['text'=>"وضعیت",'callback_data'=>"VPNFREE_4"],['text'=>"تنظیمات",'callback_data'=>"VPNFREE_4"],['text'=>"نوعیت",'callback_data'=>"VPNFREE_4"],['text'=>"سرور",'callback_data'=>"VPNFREE_4"]];
    if($cats->num_rows == 0){
        $keys[] = [['text'=>"سروری یافت نشد",'callback_data'=>"VPNFREE_4"]];
    }else {
        while($cty = $cats->fetch_assoc()){
            ...
            $keys[] = [['text'=>$state,'callback_data'=>'toggleServerState' . $id . "_" . $offset],['text'=>"⚙️",'callback_data'=>"showServerSettings" . $id . "_" . $offset],['text'=>$serverType??" ",'callback_data'=>"VPNFREE_4"],['text'=>$cname,'callback_data'=>"VPNFREE_4"]];
        } 
    }
...
function getCategoriesKeys($offset = 0){
    ...
    $keys = array();
    $keys[] = [['text'=>"حذف",'callback_data'=>"VPNFREE_4"],['text'=>"اسم دسته",'callback_data'=>"VPNFREE_4"]];
    if($cats->num_rows == 0){
        $keys[] = [['text'=>"دسته بندی یافت نشد",'callback_data'=>"VPNFREE_4"]];
    }else {
        while($cty = $cats->fetch_assoc()){
            $id = $cty['id'];
            $cname = $cty['title'];
            $keys[] = [['text'=>"❌",'callback_data'=>"vpnshopcategorydelete$id" . "_" . $offset],['text'=>$cname,'callback_data'=>"vpnshopcategoryedit$id" . "_" . $offset]];
        }
    }
...
function getBotSettingKeys(){
    ...
    $plandelkhahvpn = $botState['plandelkhahState']=="on"?$buttonValues['on']:$buttonValues['off'];
...
function getBotReportKeys(){
    ...
    return json_encode(['inline_keyboard'=>[
        [
            ['text'=>$allUsers,'callback_data'=>'VPNFREE_4'],
            ['text'=>"تعداد کل کاربران",'callback_data'=>'VPNFREE_4']
            ],
        [
            ['text'=>$allOrders,'callback_data'=>'VPNFREE_4'],
            ['text'=>"کل محصولات خریداری شده",'callback_data'=>'VPNFREE_4']
            ],
        [
            ['text'=>$allServers,'callback_data'=>'VPNFREE_4'],
            ['text'=>"تعداد سرورها",'callback_data'=>'VPNFREE_4']
            ],
        [
            ['text'=>$allCategories,'callback_data'=>'VPNFREE_4'],
            ['text'=>"تعداد دسته ها",'callback_data'=>'VPNFREE_4']
            ],
        [
            ['text'=>$allPlans,'callback_data'=>'VPNFREE_4'],
            ['text'=>"تعداد پلن ها",'callback_data'=>'VPNFREE_4']
            ],
        [
            ['text'=>$totalRewards,'callback_data'=>'VPNFREE_4'],
            ['text'=>"درآمد کل",'callback_data'=>'VPNFREE_4']
            ],
        [
            ['text'=>$dayReward,'callback_data'=>'VPNFREE_4'],
            ['text'=>"درآمد امروز",'callback_data'=>'VPNFREE_4']
            ],
        [
            ['text'=>$weekReward,'callback_data'=>'VPNFREE_4'],
            ['text'=>"درآمد هفته",'callback_data'=>'VPNFREE_4']
            ],
        [
            ['text'=>$monthReward,'callback_data'=>'VPNFREE_4'],
            ['text'=>"درآمد ماه",'callback_data'=>'VPNFREE_4']
            ],
        [
...
function getAdminsKeys(){
    ...
    if($usersList->num_rows > 0){
        while($user = $usersList->fetch_assoc()){
            $keys[] = [['text'=>"❌",'callback_data'=>"delAdmin" . $user['userid']],['text'=>$user['name'], "callback_data"=>"VPNFREE_4"]];
        }
    }else{
        $keys[] = [['text'=>"لیست ادمین ها خالی است ❕",'callback_data'=>"VPNFREE_4"]];
    }
    ...
    if($userCount->num_rows > 0){
        ...
        return json_encode(['inline_keyboard'=>[
            [
                ...
                ['text'=>"یوزرنیم",'callback_data'=>"VPNFREE_4"]
                ],
            [
                ['text'=>$fullName??" ",'callback_data'=>"VPNFREE_4"],
                ['text'=>"نام",'callback_data'=>"VPNFREE_4"]
                ],
            [
                ['text'=>$boughtService??" ",'callback_data'=>"VPNFREE_4"],
                ['text'=>"سرویس ها",'callback_data'=>"VPNFREE_4"]
                ],
            [
                ['text'=>$totalBoughtPrice??" ",'callback_data'=>"VPNFREE_4"],
                ['text'=>"مبلغ خرید",'callback_data'=>"VPNFREE_4"]
                ],
            [
                ['text'=>$userWallet??" ",'callback_data'=>"VPNFREE_4"],
                ['text'=>"موجودی کیف پول",'callback_data'=>"VPNFREE_4"]
                ],
            [
...
function getDiscountCodeKeys(){
    ...
    $keys = array();
    if($list->num_rows > 0){
        $keys[] = [['text'=>'حذف','callback_data'=>"VPNFREE_4"],['text'=>"استفاده هر یوزر",'callback_data'=>"VPNFREE_4"],['text'=>"تاریخ ختم",'callback_data'=>"VPNFREE_4"],['text'=>"تعداد استفاده",'callback_data'=>"VPNFREE_4"],['text'=>"مقدار تخفیف",'callback_data'=>"VPNFREE_4"],['text'=>"کد تخفیف",'callback_data'=>"VPNFREE_4"]];
        while($row = $list->fetch_assoc()){
            ...
            $keys[] = [['text'=>'❌','callback_data'=>"delDiscount" . $rowId],['text'=>$canUse, 'callback_data'=>"VPNFREE_4"],['text'=>$date,'callback_data'=>"VPNFREE_4"],['text'=>$count,'callback_data'=>"VPNFREE_4"],['text'=>$amount,'callback_data'=>"VPNFREE_4"],['text'=>$hashId,'callback_data'=>'copyHash' . $hashId]];
        }
    }else{
        $keys[] = [['text'=>"کد تخفیفی یافت نشد",'callback_data'=>"VPNFREE_4"]];
    }
    ...
    if($buttons->num_rows > 0){
        while($row = $buttons->fetch_assoc()){
            ...
            $keys[] = [
                        ...
                        ['text'=>$title??" " ,'callback_data'=>"VPNFREE_4"]];
        }
    }else{
        $keys[] = [['text'=>"دکمه ای یافت نشد ❕",'callback_data'=>"VPNFREE_4"]];
    }
...
function getPlanDetailsKeys($planId){
    ...
    if($pdResult->num_rows == 0) return null;
        ...
        $stmt->bind_param("i", $id);
        $stmt->execute();
        $vpnshopplanaccnumber = $stmt->get_result()->num_rows;
        $stmt->close();

        $srvid= $pd['server_id'];
        $keyboard = [
            ($rahgozar==true?[['text'=>"* نوع پلن: رهگذر *",'callback_data'=>'VPNFREE_4']]:[]),
            ($rahgozar==true?[
                ['text'=>$customPath,'callback_data'=>'changeCustomPath' . $id],
                ['text'=>"Path Custom",'callback_data'=>'VPNFREE_4'],
                ]:[]),
            ($rahgozar==true?[
                ['text'=>$customPort,'callback_data'=>'changeCustomPort' . $id],
                ['text'=>"پورت دلخواه",'callback_data'=>'VPNFREE_4'],
                ]:[]),
            ($rahgozar==true?[
                ['text'=>$customSni,'callback_data'=>'changeCustomSni' . $id],
                ['text'=>"sni دلخواه",'callback_data'=>'VPNFREE_4'],
                ]:[]),
            [['text'=>$name,'callback_data'=>"vpnshopplanname$id"],['text'=>"🔮 نام پلن",'callback_data'=>"VPNFREE_4"]],
            ($reality == "true"?[['text'=>$dest,'callback_data'=>"editDestName$id"],['text'=>"dest",'callback_data'=>"VPNFREE_4"]]:[]),
            ($reality == "true"?[['text'=>$serverName,'callback_data'=>"editServerNames$id"],['text'=>"serverNames",'callback_data'=>"VPNFREE_4"]]:[]),
            ($reality == "true"?[['text'=>$spiderX,'callback_data'=>"editSpiderX$id"],['text'=>"spiderX",'callback_data'=>"VPNFREE_4"]]:[]),
            ($reality == "true"?[['text'=>$flow,'callback_data'=>"editFlow$id"],['text'=>"flow",'callback_data'=>"VPNFREE_4"]]:[]),
            [['text'=>$vpnshopplanaccnumber,'callback_data'=>"VPNFREE_4"],['text'=>"🎗 تعداد اکانت های فروخته شده",'callback_data'=>"VPNFREE_4"]],
            ($pd['inbound_id'] != 0?[['text'=>"$acount",'callback_data'=>"vpnshopplanslimit$id"],['text'=>"🚪 تغییر ظرفیت کانفیگ",'callback_data'=>"VPNFREE_4"]]:[]),
            ($pd['inbound_id'] != 0?[['text'=>$pd['inbound_id'],'callback_data'=>"vpnshopplansinobundid$id"],['text'=>"🚪 سطر کانفیگ",'callback_data'=>"VPNFREE_4"]]:[]),
            [['text'=>"✏️ ویرایش توضیحات",'callback_data'=>"vpnshopplaneditdes$id"]],
            [['text'=>number_format($price) . " تومان",'callback_data'=>"vpnshopplanrial$id"],['text'=>"💰 قیمت پلن",'callback_data'=>"VPNFREE_4"]],
            [['text'=>"♻️ دریافت لیست اکانت ها",'callback_data'=>"vpnshopplanacclist$id"]],
            [['text'=>"✂️ حذف",'callback_data'=>"vpnshopplandelete$id"]],
        ...
        if($inbound_id == 0){
            if($protocol == 'trojan') {
                if($security == "xtls"){
                    $keyboard = [
                        [
            			    ['text' => $userId, 'callback_data' => "VPNFREE_4"],
                            ['text' => "آیدی کاربر", 'callback_data' => "VPNFREE_4"],
                        ],
                        [
            			    ['text' => $firstName, 'callback_data' => "VPNFREE_4"],
                            ['text' => "اسم کاربر", 'callback_data' => "VPNFREE_4"],
                        ],
                        [
            			    ['text' => $isAgentBought, 'callback_data' => "VPNFREE_4"],
                            ['text' => "خرید نماینده", 'callback_data' => "VPNFREE_4"],
                        ],
                        [
            			    ['text' => "$name", 'callback_data' => "VPNFREE_4"],
                            ['text' => $buttonValues['plan_name'], 'callback_data' => "VPNFREE_4"],
                        ],
                        [
            			    ['text' => "$date ", 'callback_data' => "VPNFREE_4"],
                            ['text' => $buttonValues['buy_date'], 'callback_data' => "VPNFREE_4"],
                        ],
                        [
            			    ['text' => "$expire_date ", 'callback_data' => "VPNFREE_4"],
                            ['text' => $buttonValues['expire_date'], 'callback_data' => "VPNFREE_4"],
                        ],
                        [
            			    ['text' => " $leftgb", 'callback_data' => "VPNFREE_4"],
                            ['text' => $buttonValues['volume_left'], 'callback_data' => "VPNFREE_4"],
            			],
                        [
                            ['text' => $buttonValues['selected_protocol'], 'callback_data' => "VPNFREE_4"],
                        ],
                        [
                            ['text' => $protocol == 'trojan' ? '☑️ trojan' : 'trojan', 'callback_data' => "VPNFREE_4"],
                            ['text' => $protocol == 'vless' ? '☑️ vless' : 'vless', 'callback_data' => "VPNFREE_4"],
                        ],
                        [
                    ...
                    $keyboard = [
                        ...
                        [
                            ['text' => $protocol == 'trojan' ? '☑️ trojan' : 'trojan', 'callback_data' => "VPNFREE_4"],
                            ['text' => $protocol == 'vmess' ? '☑️ vmess' : 'vmess', 'callback_data' => "VPNFREE_4"],
                            ['text' => $protocol == 'vless' ? '☑️ vless' : 'vless', 'callback_data' => "VPNFREE_4"],
                        ],
                        [
                            ['text'=>($enable == true?$buttonValues['disable_config']:$buttonValues['enable_config']),'callback_data'=>"changeUserConfigState" . $order['id']],
            ...
            $keyboard = [
                ...
                [
                    ['text' => " $protocol ☑️", 'callback_data' => "VPNFREE_4"],
                ],
                [
                    ['text'=>($enable == true?$buttonValues['disable_config']:$buttonValues['enable_config']),'callback_data'=>"changeUserConfigState" . $order['id']],
                    ['text'=>$buttonValues['delete_config'],'callback_data'=>"delUserConfig" . $order['id']],
