...
function updateBot(){
    global $arrays, $connection, $walletvpnshop, $nowPaymentKey, $zarinpalId;
    ...
    if(isset($nowPaymentKey) && isset($zarinpalId)){
        $paymentKeys = array();
        $paymentKeys['bankAccount'] = $walletvpnshop;
    ...
    if(file_exists(getcwd() . '/settings/messagevpnshop.json')) unlink('../settings/messagevpnshop.json');
}
?>
